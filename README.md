...
```sh
git clone https://github.com/tonyn10/tonyn10.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/tonyn10/tonyn10.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/tonyn10/tonyn10.nvim.git "${env:LOCALAPPDATA}\nvim"
```
